#ifndef _H_X_FITNESS_CASE_H
#define _H_X_FITNESS_CASE_H
...
namespace symreg
{
	...
	public:
		virtual void SetInput(double x, unsigned int index=0) { m_x = x; }
		...
		virtual void QueryInput(unsigned int index, double* input) const { *input=m_x; }
	...
	public:
		unsigned int GetInputCount() const { return 1; }
