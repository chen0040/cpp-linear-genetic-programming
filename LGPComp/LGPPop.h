...
protected:
	bool m_bSetup;
public:
	virtual void BreedInitialPopulation();
	virtual void Evolve(); // evolve of a new generation of programs using steady-state LGP model
...
public:
	...
	virtual void InitializeProgramRegisters(LGPProgram* lgp, const LGPFitnessCase* fitness_case);
